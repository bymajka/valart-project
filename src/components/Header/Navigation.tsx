...
const Navigation = () => {
  return (
    <nav className="flex items-center flex-row absolute right-[12px] md:right-[66px] top-[10px] md:top-[16px] gap-[60px] md:w-[444px] h-[32px] md:h-[38px] text-[12px] font-poppins-semibold">
      ...
      <button className="group w-[123px] h-[32px] md:h-[38px] rounded-full bg-gradient-to-r from-gold-21 to-gold-22 flex items-center justify-center cursor-pointer transition-all duration-300 ">
